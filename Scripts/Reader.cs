...
public class Reader : MonoBehaviour
{
    ...
    public Level1_GameController gameController;
    //public Level2_GameController gameController2;
    ...
    /* Find all of the cards game object using the tag, then check if their order mactches their names */
    public void Play()
    {        
        cards = GameObject.FindGameObjectsWithTag("Card");
        cardList = new System.Collections.Generic.List<GameObject>(cards);  // same as cards
